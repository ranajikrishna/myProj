...
# notorious criminals on the inescapable island of Alcatraz. Today, the city is known more 
# for its tech scene than its criminal past. But, with rising wealth inequality, housing shortages,
# and a proliferation of expensive digital toys riding BART to work, there is no scarcity 
# of crime in the city by the bay. From Sunset to SOMA, and Marina to Excelsior, this competition's 
...
# We're also encouraging you to explore the dataset visually. What can we learn about the city
# through visualizations like this Top Crimes Map? The top most up-voted scripts from this competition 
# will receive official Kaggle swag as prizes. 
# ******
